...
- `docs/guides/MIGRATION_GUIDE.md`: full client-facing guide for Blackbaud → Benevolence migration
- `docs/engineering/AI_IMPORTER_BLUEPRINT.md`: all sprints marked DONE, final stats added
