...
`docs/agent-work/specs/2026-07-26-refactor-findings.md` instead of fixed.
...
5. Create the findings file stub
   (`docs/agent-work/specs/2026-07-26-refactor-findings.md`) so behavior quirks
...
`docs/agent-work/plans/2026-08-05-refactor-phase5-schema-alignment.md`.
