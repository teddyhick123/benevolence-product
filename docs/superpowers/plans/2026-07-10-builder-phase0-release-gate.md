...
Run: `grep -rn "opened as PRs directly\|Mark shipped\|mark it shipped\|marked shipped" docs components app lib --include='*.md' --include='*.ts' --include='*.tsx' | grep -v BUILDER_REVIEW_ORCHESTRATION_AUDIT | grep -v superpowers/plans`
