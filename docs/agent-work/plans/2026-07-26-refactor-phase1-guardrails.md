...
- Behavior quirks discovered along the way: log to `docs/agent-work/specs/2026-07-26-refactor-findings.md`, don't fix. Security bugs: stop this infrastructure plan and create a dedicated, explicitly reviewed fix commit with regression coverage.
...
- Create: `docs/agent-work/specs/2026-07-26-refactor-findings.md`
...
```bash
git add .gitignore package-lock.json docs/agent-work/specs/2026-07-26-refactor-findings.md
...
Phase 1 of docs/agent-work/specs/2026-07-26-full-refactor-design.md. Infrastructure only — no route, page, or library behavior changes.
