...
Spec created when phase begins: `docs/superpowers/specs/<date>-phase1-workflow-config-design.md`
...
Spec created when phase begins: `docs/superpowers/specs/<date>-phase2-custom-fields-design.md`
...
1. **Before starting a phase:** Brainstorm and write the phase's implementation spec (`docs/superpowers/specs/`). Use that spec to generate the implementation plan (`docs/superpowers/plans/`).
