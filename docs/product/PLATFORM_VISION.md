...
The full architectural sketch — current configurability layers, the major missing runtime layers, how the Builder evolves, and what the end state looks like — is in [`CONFIGURABILITY_ARCHITECTURE.md`](../engineering/CONFIGURABILITY_ARCHITECTURE.md).
