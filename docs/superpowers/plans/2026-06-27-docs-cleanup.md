...
| `docs/superpowers/plans/` (pre-2026-05-28) | **Archive** | Completed sprint plans. Preserve as history; do not treat as current. |
...
**Files:**
- Move: `docs/superpowers/plans/2026-04-*.md`, `docs/superpowers/plans/2026-05-*.md` → `docs/archive/plans/`
- Keep in place: `docs/superpowers/plans/2026-06-*.md` (recent, may still be active)
